...
#'      parallel}
#'   \item{elementsParallelFaster}{Number of data elements required for a parallel version with
#'   maxWorker workers to be faster than serial. Can be Inf if parallel
#'   will never be faster than serial.}
#'   \item{}{}
#' }
XXX = function()
{
