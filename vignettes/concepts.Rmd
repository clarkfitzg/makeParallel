...
makeParallel takes general R code and automatically transforms it into
parallel code. Thus the __system__ must determine a correct and reasonably
efficient way to execute parts of the program in parallel. In contrast,
...
by providing their own programming model / API.
