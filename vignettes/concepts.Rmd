...
1. Identify conditional versus unconditional variable assignment and handle
   appropriately
...
1. Non standard evaluation (NSE) complicates static code analysis
   because it changes the semantics of the language.
   [data.table](https://cran.r-project.org/package=data.table) and
   [dplyr](https://cran.r-project.org/package=dplyr) are two popular
   packages that use NSE.
