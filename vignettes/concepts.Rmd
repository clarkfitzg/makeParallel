...
The next step is to bring in more information on the system and the data to
analyze. In this way we build more intelligence into the system, freeing
the user to write higher level code that also performs better.
...
makeParallel relies on existing infrastructure wherever possible. For
