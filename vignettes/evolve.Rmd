...
The `arg_metadata` function captures the relevant metadata for an
operation. To make a custom `arg_metadata` functions, as with the
...
In the more general case of the different argument signatures...

The default just counts the number of rows for the first
argument. 
