...
The user does not have to explicitly and manually send the variables over.


## Limitations

`codedoctor` is not currently designed to work with multiple large
...
parallel::stop_cluster(attr(do, "cluster"))
