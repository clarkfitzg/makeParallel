...
Have vignette be different from README, README can be more like plans for
where we're going with this.

TODO: Call out what I'm using, CodeDepends, rstatic
TODO: Start out with where this could go, breadth
...
pcode = makeParallel(code, scheduler = task_scheduler
