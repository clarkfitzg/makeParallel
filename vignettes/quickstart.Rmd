...
When we evaluate this we see that the results are the same. The one
difference is that `lapply` added names to make the output more
intelligible, which is a good thing.

```{r, echo = FALSE, results = "hide"}
stopifnot( all(Map(`==`, m1, m2)) )
```
