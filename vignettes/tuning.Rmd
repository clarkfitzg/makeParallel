...
and presence of NA's / NULL's.

IDEA: We can also increase speed by removing or modifying code inside the
function that doesn't apply based on the characteristics of the sample
data. For example, if we know that the class of the input is numeric we can
turn off or remove a bunch of code, ie. inside `stats::cov`:
