...
12 seconds = 400 MB / second. Can I verify this?
...
system.time(cargo <- read.table("~/data/CargoDescriptions2015.csv"
    ...
    , colClasses = strsplit("numeric character int int character", " ")
    ))

system.time(containers <- read.table("~/data/CargoDescriptions2015.csv"
    , header = TRUE, sep = ",", quote = "\""
    , colClasses = strsplit("NULL character NULL NULL NULL", " ")
    ))

# Error in scan(file = file, what = what, sep = sep, quote = quote, dec = dec,  :
#   line 12268020 did not have 5 elements
# Timing stopped at: 175.338 1.78 177.223
